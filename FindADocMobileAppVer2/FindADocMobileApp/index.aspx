<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="FindADocMobileApp.index" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var serviceurl = "https://mhealth.texashealth.org/findadocsvc/FindADoc.svc";
        var defaultloc = '';
        ...
        if (navigator.geolocation) {
            ...
            navigator.geolocation.getCurrentPosition(function (position) {
				...
				function (error) {
				    $("#errormsg").html('Please Enable Location Services');
				},
				{
				    timeout: (5 * 1000),
				...
				function (position) {
				    ...
				    geocoder2.geocode({ 'latLng': latlng2 }, function (results, status) {
				        if (status == google.maps.GeocoderStatus.OK) {
				            defaultloc = results[1].formatted_address;
				            defaultboolloc = '1';
				            $("#errorMsgForWifi").html("<br>Current location from ISP: " + defaultloc);
				        }
				    });
				    // alert("in get current position" + defaultloc);
        ...
        $('#page2').live('pageshow', function () {
            ...
            $("#refind").hide();
            $("#refind1").hide();
            $("#errormsg").html("Current latitude: " + currentlatitude + "<br/>&nbsp;&nbsp;Current logitude: " + currentlongitude);
        ...
        function MapDisplay(mapdocname) {
            ...
            var nameadress = '<a onclick="SetValue(' + valid + ')" href="#details" data-transition="slide">' + mapdocname + ' </a></br>' + mapaddress + '</br><a href="#directions_map" onclick="getmapaddress(' + valid + ');" data-transition="slide">Get Directions</a>';
    ...
    marker: {
        ...
        events: {
            ...
            for (i = 0; i < jsonObj.length; i++) {
                ...
                var tempadd = '<a onclick="SetValue(' + jsonObj[i].docid + ')" href="#details" data-transition="slide">' + docname + '</a><br/>' + trimaddress + '</br><a href="#directions_map" onclick="getmapaddress(' + jsonObj[i].docid + ');" data-transition="slide">Get Directions</a>';
        ...
        jQuery.ajaxSetup({
            beforeSend: function () {
                $("#pager").html('');
                $('#doctordetails').html('<div align="center"><img src="images/mainl.gif" style="padding-top:160px;" height="40px" width="40px" /></div>');
            }
        });
            ...
            if (result.d.length > 0) {
                ...
                for (var i = 0; i < result.d.length; i++) {
                    ...
                    if (i % 2 == 0) {
                        ...
                        if (showaddress != "") {
                            html += '<div class="even" data-theme="a"> <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td width="15%"> <span class="headerCss">Name:</span></td><td class="Detailsclass" width="65%"><span><a onclick="SetValue(' + result.d[i].id + ')" href="#details" data-transition="slide">' + result.d[i].FirstName + '  ' + result.d[i].LastName + '</a></span></td><td align="right" width="20%" style="font-size:12px;">' + midistance + '</td></tr><tr><td style="vertical-align:top;"> <span class="headerCss"  >Address:</span></td><td class="Detailsclass">' + showaddress + '</td></tr><tr><td><span class="headerCss">Phone: </span> </td><td class="Detailsclass"><a class="mapclass" style="text-decoration:none;" href="tel:' + result.d[i].Phone + '">' + result.d[i].Phone + '</a></td></tr><tr><td></td><td class="Detailsclass"><span><a href="#basic_map" onclick="getmapaddress(' + result.d[i].id + ');" data-transition="slide">Map</a>&nbsp;&nbsp;&nbsp;<a href="#directions_map" onclick="getmapaddress(' + result.d[i].id + ');" data-transition="slide">Get Directions</a></span></td></tr></table></div><div style="height:5px; width:20px;"></div>';

                        }
                        else {
                            html += '<div class="even" data-theme="a"> <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td width="15%"> <span class="headerCss">Name:</span></td><td class="Detailsclass" width="65%"><span><a onclick="SetValue(' + result.d[i].id + ')" href="#details" data-transition="slide">' + result.d[i].FirstName + '  ' + result.d[i].LastName + '</a></span></td><td align="right" width="20%" style="font-size:12px;"></td></tr><tr><td><span class="headerCss">Phone: </span> </td><td class="Detailsclass"><a class="mapclass" style="text-decoration:none;" href="tel:' + result.d[i].Phone + '">' + result.d[i].Phone + '</a></td></tr></table></div><div style="height:5px; width:20px;"></div>';
...
<body>
            ...
            <div align="center" style="padding-top: 30px;">
                <ul data-role="listview" class="mainmenu">
                    <li><a style="padding: 7px; text-align: center; text-shadow: 0 0 0px rgba(0,0,0,0);
                        ...
                        height: 20px;" href="#page2" data-transition="slide">Find A Physician</a></li>
                    <li><a style="padding: 7px; text-align: center; text-shadow: 0 0 0px rgba(0,0,0,0);
                        border: 0px solid black; -moz-border-radius: 10px; border-radius: 10px; color: White;
                        height: 20px;" href="#page3" data-transition="slide">Locations</a></li>
    ...
    <div data-role="page" id="page2">
        ...
        <div data-role="content">
            <div id="norecordfound" style="color: Red; font-size: 11px;">
            </div>
            ...
            <span id="errorMsgForWifi" style="color: Red; font-size: 10px; padding-left: 6px;">
            </span>
            <%--     <div align="center">
            ...
            <div class="even">
                ...
                <div style="font-size: 12px;">
                    ...
                    TX 75013&nbsp;|&nbsp;<a class="mapclass" onclick="mapdisplay1(33.11628370,-96.67425329999999,'Texas Health Allen','1105 Central Expressway, Allen, TX, 75013');"
                        href="#basic_map" data-transition='slide'>Map</a><br />
            ...
            <div class="odd">
                ...
                <div style="font-size: 12px;">
                    ...
                    TX 75070&nbsp;|&nbsp;<a onclick="mapdisplay1(33.1429720,-96.71657990,'Texas Health Craig','Ranch 7850 Collin McKinney Parkway McKinney,TX 75070');"
                        href="#basic_map" data-transition='slide'>Map</a>
                    <br />
    ...
    <div data-role="page" id="page6">
        ...
        <div data-role="content" style="text-align: center; text-align: left;">
            ...
            <div id="refind1" align="center" style="padding-bottom: 8px; font-size: 12px; display: none;
                color: Red;">
               <a data-transition="slide" href="#" style="text-decoration: none;"
                    onclick="backfunction();">Too many records found, Refine your search</a></div>
